	...
	function ReplaceUnderscoreWithSpace($girilen_deger) 
 	{
		...
		$liststr = "";
		for($i = 0; $i <strlen($girilen_deger); $i++) // Döngü oluşturuluyor.
	{
		
		$char = substr( $girilen_deger, $i, 1 ); // Üç adet bölüme ayırır ; $girilen_deger kısmı işlem yapacağımız cümle veya karakter gurubunun bulunduğu değişkendir. 
